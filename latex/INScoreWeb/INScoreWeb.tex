...
\item midikey, \OSC{vel}, \OSC{prog}, \OSC{ctrl}: are used to select MIDI messages according to their status and values.
\end{itemize}
...
Literal values are a single value or a list of space separated values enclosed in brackets. All the values must be in the MIDI data range (0-127).

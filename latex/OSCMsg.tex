...
\title{INScore \\ OSC Messages Reference \\v.1.27}
...
\vspace*{5mm}
Throughout the documentation, the sample code are given using scripting syntax i.e. that OSC messages are suffixed with a semi-colon ';'. This semi-colon is used as a message separator in INScore scripts and is not needed when sending messages over a network.
\end{minipage}}
